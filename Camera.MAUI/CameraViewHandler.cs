...
#if ANDROID
    public void RegisterCallbackForProcessGrabbedImage(Camera.MAUI.Platforms.Android.MauiCameraViewCallBack.ImageAvailableEventHandler callback)
    {

        PlatformView.RegisterCallbackForProcessGrabbedImage(callback);

    }

    public void UnRegisterCallbackForProcessGrabbedImage(Camera.MAUI.Platforms.Android.MauiCameraViewCallBack.ImageAvailableEventHandler callback)
    {

        PlatformView.UnregisterCallbackForProcessGrabbedImage(callback);
